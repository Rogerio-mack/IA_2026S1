...
5. **Entrega**. No formato de um artigo SBC, preferencialmente em Latex. Apresentação no YouTube (máximo 6min) com o link a ser incluído no GitHub.
